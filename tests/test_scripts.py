...
class SearchCansScriptTests(unittest.TestCase):
    ...
    def test_account_snapshot_is_sanitized_before_reporting(self) -> None:
        module = load_module("account_client", "skills/searchcans-deep-research/scripts/searchcans_v1.py")
    ...
    def test_account_guard_blocks_an_insufficient_enforced_job(self) -> None:
        module = load_module("account_guard_client", "skills/searchcans-serp-content-gap/scripts/searchcans_v1.py")
    ...
    def test_reader_audit_blocks_before_the_business_request(self) -> None:
        module = load_module("reader_budget_block", "skills/searchcans-reader-seo-audit/scripts/reader_page_audit.py")
    ...
    def test_deep_research_caps_sources_and_concurrency_to_account_limits(self) -> None:
        module = load_module("deep_research_budget", "skills/searchcans-deep-research/scripts/deep_research.py")
    ...
    def test_market_watch_selects_diverse_news_domains_and_budget_caps_reads(self) -> None:
        module = load_module("market_watch", "skills/searchcans-market-watch/scripts/market_watch.py")
    ...
    def test_product_brief_normalizes_observed_price_without_price_claim(self) -> None:
        module = load_module("product_brief", "skills/searchcans-product-serp-brief/scripts/product_serp_brief.py")
        original_post = module.post
    ...
    def test_content_format_normalizes_video_and_short_video_shapes(self) -> None:
        module = load_module("format_brief", "skills/searchcans-content-format-brief/scripts/content_format_brief.py")
    ...
    def test_rag_curator_preserves_explicit_files_and_diversifies_search_domains(self) -> None:
        module = load_module("rag_curator", "skills/searchcans-rag-source-curator/scripts/rag_source_curator.py")
